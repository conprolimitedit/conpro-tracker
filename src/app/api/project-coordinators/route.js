...
export async function POST(request) {
    try {
        ...
        // Duplicate check on (fullName, company)
        ...
        if ((dupCheck?.length || 0) > 0) {
            return NextResponse.json({ success: false, error: 'Project coordinator with this name and company already exists.' }, { status: 409 })
        }
